...
class LoginView(APIView):
    ...
    def post(self, request: Request):
        ...
        if user is not None:
            ...
            response = {"message": "Login Successfull", "tokens": tokens,"role":str(user.role),"id":user.id,"image":str(user.image),"username":str(user.username),"firstName":str(user.first_name),"lastName":str(user.last_name)}
