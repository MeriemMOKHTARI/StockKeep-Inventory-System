                  ...
                  <tr>
                    ...
                    <td className="border-b border-blue-gray-50 p-4 w-[200px]">
                      <div className="flex justify-start">
                        ...
                        {status.etat === "Not Approuved" ? (
                          <div className="border rounded-[15px] w-[110px] h-[40px] flex items-center justify-center mr-[1px] bg-[#2185D5] hover:bg-[#1978C5] text-white">
                            <EditStatus
                              StatusId={status.id}
                              open={openEdit}
                            ...
                            >
                              ...
                              >
                                <EditIcon strokeWidth={2} className="h-6 w-6" />
                                Edit
                              </Button>
                            </EditStatus>
                          </div>
